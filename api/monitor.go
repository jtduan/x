      ...
      <main>
        <div class="layout">
          <div class="left">
            ...
            <div class="card">
              <h3>
                <span>Downstream -> traffic (total)</span>
            ...
            <div class="card">
              <h3>
                <span>Downstream -> traffic (rate)</span>
